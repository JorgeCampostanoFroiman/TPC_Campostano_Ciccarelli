<%@ Page Title="Contact" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="TPC_Campostano_Ciccarelli.Contact" %>
        ...
        <div class="login-container text-c animated flipInX">
                ...
                <div class="container-content">
                    <form class="margin-t">
                        ...
                        <a class="text-darkyellow" href="Registro.aspx""><small>Registrarse!</small></a>
                    </form>
